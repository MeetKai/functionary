...
gpu_config_mapping = {
    "meetkai/functionary-medium-v3.2": modal.gpu.A100(count=2, size="80GB"),
    "meetkai/functionary-small-v3.2": modal.gpu.A10G(count=1),
...
class Settings(BaseSettings):
    model: str = "meetkai/functionary-medium-v3.2"
    ...
    container_idle_timeout: int = 120  # In seconds
