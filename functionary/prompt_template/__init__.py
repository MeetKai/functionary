...
from functionary.prompt_template.llama3_instruct_prompt_template import Llam3InstructTemplate
...
def get_prompt_template_by_version(version: str) -> PromptTemplate:
    if version == "v2.llama3_instruct":
        return Llam3InstructTemplate.get_prompt_template()
...
def get_prompt_template_from_tokenizer(tokenizer: Any) -> PromptTemplate:
    ...
    p3 = Llam3InstructTemplate.get_prompt_template()
